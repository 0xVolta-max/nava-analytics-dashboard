...
const SocialWeatherWidget = () => {
  ...
  return (
    <>
      <div className="bg-white/10 backdrop-blur-xl border border-white/15 rounded-2xl p-5 flex flex-col h-full max-w-lg mx-auto">
        <div className="flex justify-between items-center mb-4">
          <h3 className="font-semibold text-white/90">Social Weather</h3>
        ...
        <div className="flex-grow grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-center justify-center p-4 rounded-lg bg-white/5">
            <WeatherIcon icon={weather.icon} color={weather.color} label={weather.label} />
          </div>
          <div className="space-y-3 flex flex-col justify-center">
            <div>
              <p className="text-5xl font-bold text-white">{formatEngagement(data.global.engagementE)}</p>
              <p className="text-sm text-white/70">Feels like {formatEngagement(data.global.feelsLikeE)}</p>
            </div>
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between items-center">
                <span className="text-white/70">Viral Chance</span>
              ...
              <div>
                 <span className="text-white/70 text-xs">Buzz Pressure</span>
